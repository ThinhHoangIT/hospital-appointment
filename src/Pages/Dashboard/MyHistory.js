      ...
      <div class="container flex flex-col items-center px-4 py-12 mx-auto lg:flex-row">
        ...
        <div class="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
          ...
          <p class="block max-w-2xl mt-4 text-xl text-gray-500 dark:text-gray-300">
            They cover a wide range of humanities subjects, from American
            history to literature, world history and culture, civics, language,
            art, architecture, and archaeology, and have been judged by
          ...
          <div class="mt-6 sm:-mx-2">
            ...
            <div class="inline-flex w-full mt-4 overflow-hidden  rounded-lg shadow sm:w-auto sm:mx-2 sm:mt-0">
              <a
                href="#"
                class="inline-flex my-4 items-center justify-center w-full px-5 py-3 text-base font-medium text-white transition-colors duration-150 transform sm:w-auto bg-gradient-to-r from-blue-700 to-blue-900 hover:from-blue-600 hover:to-blue-600"
              >
                <svg
                  class="w-6 h-6 mx-2 fill-current"
